...
exports.MIN_OCR_CONFIDENCE = exports.AI_CONFIDENCE_THRESHOLD = exports.NON_OVERRIDABLE_REJECTION_CODES = exports.REJECTION_PRIORITY_ORDER = exports.REJECTION_REASON_CODES = exports.VERIFICATION_STATUS = exports.DOCUMENT_CATEGORY_DISPLAY_NAMES = exports.DOCUMENT_CATEGORIES = void 0;
exports.getRejectionReasonMessage = getRejectionReasonMessage;
exports.isRejectionOverridable = isRejectionOverridable;
exports.getRequiredOverrideRole = getRequiredOverrideRole;
...
exports.DOCUMENT_CATEGORY_DISPLAY_NAMES = {
    ...
    [exports.DOCUMENT_CATEGORIES.EDUCATIONAL_DOCUMENTS]: 'Educational Documents',
    [exports.DOCUMENT_CATEGORIES.EXPERIENCE_CERTIFICATES]: 'Experience Certificates',
    [exports.DOCUMENT_CATEGORIES.NAVTTC_REPORTS]: 'NAVTTC Reports',
    [exports.DOCUMENT_CATEGORIES.CERTIFICATES]: 'Professional Certificates',
 ...
 */
exports.REJECTION_REASON_CODES = {
 ...
 */
exports.REJECTION_PRIORITY_ORDER = [
    exports.REJECTION_REASON_CODES.CNIC_MISMATCH,
    exports.REJECTION_REASON_CODES.PASSPORT_MISMATCH,
    exports.REJECTION_REASON_CODES.DOB_MISMATCH,
    exports.REJECTION_REASON_CODES.NAME_MISMATCH,
    exports.REJECTION_REASON_CODES.EMAIL_MISMATCH,
    exports.REJECTION_REASON_CODES.PHONE_MISMATCH,
    exports.REJECTION_REASON_CODES.FATHER_NAME_MISMATCH,
];
/**
 * Rejection codes that cannot be overridden by regular admin
 * Require super_admin role for override
 */
exports.NON_OVERRIDABLE_REJECTION_CODES = [
    exports.REJECTION_REASON_CODES.DOCUMENT_TAMPERED,
    exports.REJECTION_REASON_CODES.PHOTO_MISMATCH,
];
/**
...
function getRejectionReasonMessage(code, documentCategory, context) {
    ...
    switch (code) {
        ...
        // Matching
        case exports.REJECTION_REASON_CODES.NO_ID_FOUND:
            return `No identity fields found in ${docType.toLowerCase()}`;
        case exports.REJECTION_REASON_CODES.MULTIPLE_CANDIDATES:
            return `${docType} matches multiple candidates`;
        case exports.REJECTION_REASON_CODES.CANDIDATE_NOT_FOUND:
            return `No matching candidate found for ${docType.toLowerCase()}`;
        // CV-Specific
        case exports.REJECTION_REASON_CODES.CV_INCOMPLETE:
            return `CV is missing required sections`;
        case exports.REJECTION_REASON_CODES.CV_FORMAT_ERROR:
            return `CV format error or unsupported structure`;
        // Certificate-Specific
        case exports.REJECTION_REASON_CODES.CERTIFICATE_INVALID:
            return `Certificate is invalid or not recognized`;
        case exports.REJECTION_REASON_CODES.ISSUING_AUTHORITY_MISMATCH:
            return `Issuing authority does not match expected authority`;
        // Medical-Specific
        case exports.REJECTION_REASON_CODES.MEDICAL_INVALID:
            return `Medical report is invalid or not recognized`;
        case exports.REJECTION_REASON_CODES.MEDICAL_EXPIRED:
            return `Medical report has expired`;
        // Generic
        case exports.REJECTION_REASON_CODES.LOW_CONFIDENCE:
            return `Low confidence in ${docType.toLowerCase()} verification`;
        case exports.REJECTION_REASON_CODES.MANUAL_REVIEW_REQUIRED:
 ...
 */
function isRejectionOverridable(rejectionCode) {
    return !exports.NON_OVERRIDABLE_REJECTION_CODES.includes(rejectionCode);
}
/**
 * Get required role for override
 * Returns 'super_admin' for non-overridable codes, 'admin' otherwise
 */
function getRequiredOverrideRole(rejectionCode) {
