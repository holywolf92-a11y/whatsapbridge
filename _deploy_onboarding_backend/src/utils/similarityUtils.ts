 ...
 */
export function classifyMismatchSeverity(similarity: number): 'critical' | 'major' | 'minor' {
  if (similarity >= 80) {
 ...
 */
export function analyzeIdMismatch(extractedValue: string, candidateValue: string): {
  similarity: number;
