...
export function CVParser({ cv, onClose, onSaved }: CVParserProps) {
      ...
      const interval = setInterval(() => {
        setProgress(prev => {
          if (prev >= 100) {
            ...
            // Simulate extracted data (in production, this would come from OpenAI API)
            setExtractedData(mockExtractData(cv));
            setStage('review');
            return 100;
          }
          return prev + 10;
